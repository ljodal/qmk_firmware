 ...
 */
[SYMB] = LAYOUT_gergo(
    KC_TRNS, KC_EXLM, NO_AT_MAC, NO_LCBR_MAC, NO_RCBR_MAC, KC_PIPE,                                            KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_BSLS,
    KC_TRNS, KC_HASH, KC_DLR,    NO_LPRN,     NO_RPRN,     KC_GRV,  KC_TRNS,                          KC_TRNS, KC_PLUS, KC_MINS, KC_SLSH, KC_ASTR, KC_PERC, KC_QUOT,
    KC_TRNS, KC_PERC, KC_CIRC,   NO_LBRC,     NO_RBRC,     KC_TILD, KC_TRNS, KC_TRNS,        KC_TRNS, KC_TRNS, KC_AMPR, KC_EQL,  KC_COMM, KC_DOT,  KC_SLSH, KC_MINS,
